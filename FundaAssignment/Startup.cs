...
using FundaAssignment.Providers.API.Implementation;
...
namespace FundaAssignment
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<APIConfigRoot>(Configuration.GetSection("APIConfig"));

            services.AddSingleton<IConfiguration>(Configuration);

            services.AddSingleton<IAPIProvider, FundaAPIProvider>();
        }
